...
This is the 2nd version of 2. It takes 1 argument which is a file containing specifications for the GLUT window
...
// Mutex locks for version 2 of assignment
pthread_mutex_t listLock[100];
