...
//	Edited by Ian Pascoe, Mike Martel 12-19-2018
...
// We edited this enumeration so that the number is the ascii value of the
// first letter of the direction. Helps when printing to log file.
